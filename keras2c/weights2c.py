...
class Weights2C():
    ...
    def _write_weights_Bidirectional(self, layer):
        try:
            foo = layer.forward_layer.input.shape
            foo = layer.backward_layer.input.shape
        except:
